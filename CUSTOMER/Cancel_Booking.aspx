<%@ Page Title="" Language="C#" MasterPageFile="~/CUSTOMER/CustomerMasterPage.master" AutoEventWireup="true" CodeFile="Cancel_Booking.aspx.cs" Inherits="CUSTOMER_Cancel_Booking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td>&nbsp;</td>
        <td colspan="2">
            <h2 class="auto-style4">CANCEL BOOKING</h2>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        ...
        <td colspan="2" rowspan="2" class="auto-style4">
            <asp:GridView ID="gvCancelBook" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Book_id" GridLines="Horizontal" OnRowCommand="gvCancelBook_RowCommand" Width="596px">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Book_date" HeaderText="BOOKING DATE" SortExpression="Book_date" DataFormatString = "{0:d}" />
    ...
    <tr>
        <td>&nbsp;</td>
        <td colspan="2">
            <asp:DetailsView ID="dvCancelBook" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="Book_id" ForeColor="#333333" GridLines="None" Height="50px" OnItemCommand="dvCancelBook_ItemCommand" Width="274px" OnModeChanging="dvCancelBook_ModeChanging">
