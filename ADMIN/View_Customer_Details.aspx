<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/AdminMasterPage.master" AutoEventWireup="true" CodeFile="View_Customer_Details.aspx.cs" Inherits="ADMIN_View_Customer_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style3">
        <tr>
            <td>&nbsp;</td>
            <td colspan="3"><h2 class="auto-style4">VIEW CUSTOMER DETAILS</h2></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td colspan="3" rowspan="2">
                <asp:DetailsView ID="dvCustomerProfile" runat="server" AutoGenerateRows="False" CellPadding="4" Height="50px" Width="221px" OnPageIndexChanging="dvCustomerProfile_PageIndexChanging" DataKeyNames="Cust_id" AllowPaging="True" ForeColor="#333333" GridLines="None">
                    ...
                    <Fields>
                        ...
                        <asp:BoundField DataField="Reg_date" HeaderText="Registration Date" SortExpression="Reg_date" DataFormatString = "{0:d}" ReadOnly="True" />
